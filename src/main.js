...
function authCard(inner){return `<div class="login"><div class="card"><div class="brand"><h1>Modelizador de Riesgo para Maíz <span class="version-badge">v2.9.4</span></h1><p>Riesgo agroclimático y decisiones de siembra.</p></div>${inner}</div></div>`}
